...
U analizi su korišćena ukupno **3.043 objekta**, od kojih je **148 klasifikovano kao TDE**, dok preostalih **2.895 objekata** pripada drugim klasama tranzijenata i promenljivih izvora. Cilj projekta je binarna klasifikacija objekata na **TDE** (`target = 1`) i **non-TDE** (`target = 0`).
